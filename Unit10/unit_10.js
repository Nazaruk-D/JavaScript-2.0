...
let ar1 = [0, 55, 'string', false] // переменную обьявляем здесь!!!!

function f1() {
    out = document.querySelector('.out-1');
    for (let i = 0; i < ar1.length; i++) {
    out.innerHTML += ar1[i] + ' '; // да так можно выводить!!!!
    }
}
...
function f5() {
    ...
    out.innerHTML = `${sum + ar4[0]+ar4[2]+ar4[3]}`;
}
...
let ar6 = ['Дмитрий', 'Назарук', 'весы', '29', 'сентябрь']
...
function f10() {
    ...
    out.innerHTML = ar9[1] + ar9[ar9.length - 1];
}
...
// Добавление в массив - по индексу, а не +=!!!!!. Протестируйте задачу на повторный запуск! Выведите ar16_odd в div.out-16-odd, 
