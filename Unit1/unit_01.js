...
document.querySelector('div.one').innerHTML = 'Hello World';
...
document.querySelector('div.three').innerHTML = '<h3>Всем привет!</h3>';
...
document.querySelector('div.four').innerHTML = '<h4>Тест</h4> <p>Новый параграф</p>';
...
let a = document.querySelector('div.five');
a.innerHTML = 3.1415;
...
let div7 = document.querySelector('div.seven');
...
let y1 = 6;
let y2 = 3;
document.querySelector('div.del').innerHTML = y1 / y2;
