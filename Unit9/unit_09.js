...
function f7() {
    let num = 0;
    let x = document.querySelectorAll('.out-7');
    console.log(x.length);
    while (num < x.length) {
        x[num].classList.add ('bg-7');
        num++;
    }
...
function f8() {
    let num = 0;
    let x = document.querySelectorAll('.out-8');
    console.log(x.length);
    while (num < x.length) {
        x[num].classList.toggle ('bg-8');
        num++;
    }
...
let x = document.querySelectorAll('.out-9');
...
let x10 = document.querySelectorAll ('.out-10');
function f10() {
